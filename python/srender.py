...
class Render:
    ...
    def show(self, color_mode='flat', color_map='jet', color=None, object_type=None, segment_list=None):
        ...
        #vedo.plotter.Plotter.parallel_projection(value=True)
        vp = vedo.Plotter(axes=1)
        vp.parallel_projection=False
    ...
    def show_3d_image(image, name, binary=False, spacing=None):
        ...
        #vedo.settings.useParallelProjection = True
        #vedo.plotter.Plotter.parallel_projection(image, value=True)
        vp.parallel_projection=False
        #spacing = [1, 0.1, 0.1]
        ...
        if binary:
            ...
            vp.add_slider(iso_slider, xmin=0, xmax=100, value=(threshold / image_max) * 100, pos=4,
